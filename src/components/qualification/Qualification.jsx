                ...
                <div className="qualification__sections">
                    <div
                        ...
                        <div className="qualification__data">
                            ...
                            <div>
                                ...
                                <span className="qualification__subtitle">
                                    SRM University of Science and Technology</span>
                        ...
                        <div className="qualification__data">
                            ...
                            <div>
                                ...
                                <span className="qualification__subtitle">
                                    SBOA School & Junior College</span>
                                <div className="qualification__calendar">
                                    <i className="uil uil-calendar-alt"></i>
                                    {" "}
                                    2016 - 2018
                    ...
                    <div className={toggleState === 2
                        ...
                        <div className="qualification__data">
                            ...
                            <div>
                                <h3 className="qualification__title">Make It Count</h3>
                                <span className="qualification__subtitle">
                                    Instagram Shop</span>
                                <div className="qualification__calendar">
                                    <i className="uil uil-calendar-alt"></i>
                        ...
                        <div className="qualification__data">
                            ...
                            <div>
                                <h3 className="qualification__title">RevYou</h3>
                                <span className="qualification__subtitle">
                                    A Social Reviewing Platform</span>
                                <div className="qualification__calendar">
                                    <i className="uil uil-calendar-alt"></i>
                                    {" "}Present
                                </div>
                        ...
                        <div className="qualification__data">
                            ...
                            <div>
                                <h3 className="qualification__title">CodeCraft</h3>
                                <span className="qualification__subtitle">
                                    Digital Studio</span>
                                <div className="qualification__calendar">
                                    <i className="uil uil-calendar-alt"></i>
                        ...
                        {/* <div className="qualification__data">
                            ...
                            <div>
                                <h3 className="qualification__title">Number four</h3>
                                <span className="qualification__subtitle">
                                    VRF</span>
                                <div className="qualification__calendar">
                                    <i className="uil uil-calendar-alt"></i>
